...
export ARM_ACCESS_KEY="Sf36YEuyvJyDuInrJ9KqpfIsPGK+xZEh13BVWnAjwbIySmf8h+VhG7a0DUOaZrx/LAhsAYyGVXDA+AStorDUmQ=="  # see https://docs.microsoft.com/en-us/azure/developer/terraform/store-state-in-azure-storage
echo "Done"